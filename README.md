...
Shawod is a modern web platform rebuilt using Laravel, Vue.js, and Tailwind CSS to provide better performance, maintainability, and a clean user experience.
This project was migrated from plain PHP to a modern full-stack architecture.
...
* Improved performance over legacy PHP version
