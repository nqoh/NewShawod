<template>
    <div style="padding-top: 20px; ">
        <div >
        <iframe src="Projects/2842339/index.php" width="87%" style="margin-left: 85px" height="400px" ></iframe>
        <div style="margin-left: 50px"><a style="margin-left: 50px; background-color: white; padding:5px" target = '_blank' href="Projects/2842339/index.php">
