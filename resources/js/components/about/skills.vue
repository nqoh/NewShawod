  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h2 class="section-title">Skills</h2><br>
      </div>
      ...
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="card shadow text-center">
          <div class="position-relative rounded-top progress-wrapper" data-color="#9473e6" style="background-color: rgb(211, 171, 150); ">
            <div class="wave" data-progress="850%" style="bottom: 85%;"></div>
          </div>
          <div class="card-footer bg-white">
            <h4 class="card-title">Web Developer (85%)</h4>
          </div>
        </div> 
      </div>
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="card shadow text-center">
          ...
          <div class="card-footer bg-white">
            <h4 class="card-title">Mobile Apps (60%)</h4>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="card shadow text-center">
          <div class="position-relative rounded-top progress-wrapper" data-color="#ffbcaa" style="background-color: rgb(255, 188, 170); ">
            <div class="wave" data-progress="40%" style="bottom: 40%;"></div>
          </div>
          <div class="card-footer bg-white">
            <h4 class="card-title">Softwares (40%)</h4>
          </div>
        </div>
      </div>
    </div>
