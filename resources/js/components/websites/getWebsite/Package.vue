<template>
    <div>
      <!-- Website Package Div Start Here-->
      <div class="col-sm-6">
        <div class="wow fadeInRight animated" data-wow-duration="500ms" data-wow-delay="300ms" style="visibility: visible; animation-duration: 500ms; animation-delay: 300ms; animation-name: fadeInRight;">
            ...
            <div class='pricing pricing-palden'>
                <div class='pricing-item pricing__item--featured'>
                    <div class='pricing-deco'> <div class="angazi"><img id="image" src=""  alt=""></div>
       ...
       <!---Website package Dive End Here-->


       <!-- Website Package Description Div Start-->
       <div class="row">
...
<div class="col-sm-6">
    ...
    <div class="live-preview">
        <Link :href="route('websites')" class="btn btn-common uppercase">Change</Link>
    </div>
</div>
</div>
       <!-- Website Package Description Div Edn Here-->
    </div>
</template>
