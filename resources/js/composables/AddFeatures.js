...
var  td_pg='',td_form='',td_cms,td_logo='',td_ssl='',td_protected='',td_domain='',td_chat='',td_email='',td_ehost='',td_design='',td_seos='',th='';


function create_tabe(add,item,num,prc) {

    var feature='',td_seo='',td_gallery='';
    if(add=='add_page'){
        pag =num+" pages ||";
      td_pg ="<tr><td>"+item+"</td><td >"+num+"</td><td> R"+parseFloat(prc).toFixed(2)+"</td>" +
        "<td>"+localStorage.package+"</td><td><i onclick='mx()' class='fa fa-trash-o' style='font-size: 21px; cursor: pointer; color : #ff4444'></i> </td></tr> ";
...
return {
    sub_seoc,add_seoc,sub_seop,add_seop,sub_seog,add_seog,sub_hostg,
    sub_hostp,sub_hoste,add_hostg,add_hostp,add_hoste,sub_designc,sub_designpr,
    sub_designg,add_designc,add_designpr,add_designg,sub_email,add_email,sub_chat,
    add_chat,sub_domain,add_domain,sub_protected,add_protected,sub_ssl,add_ssl,
    sub_logo,add_logo,sub_cms,add_cms,sub_gallery,add_gallery,sub_form,add_form,
    sub_page,add_page,create_tabe,remove_item
}
 }