...
function getpackage(pckname:string,bnfit1:string,bnfit2:string,bnfit3:string,
        ...
        router.visit('getpackage');
    }

function getwebsite(pckname:string,bnfit1:string,bnfit2:string,bnfit3:string,
        price:string,img:string,bnfit4:string,bnfit5:string,bnfit6:string,
        bnfit7:string,bnfit8:string,sts:string,pg:string) {
        ...
        localStorage.setItem("type",pg)
        router.visit('getwebsite');
    }

    return { getpackage , getwebsite }
