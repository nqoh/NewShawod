<template>
  <BreadCrumb title="Privacy policy"  description="Your privacy is important to us. &nbsp;" />
  ...
  <section id="clients">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="clients text-left wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                          <h4 class="title">This privacy statement provides information about the personal information that
        Shawod collects, and the ways in which Shawod uses that personal information.</h4>
                        <br>
                        <h2>Personal information collection</h2>
                        <p>Shawod may collect and use the following kinds of personal information:<br>
    ...
    information that you provide for the purpose of subscribing to the website services (including newsletters) ; and any other information that you send to Shawod.
                        ...
                        <br>
                       <h2>Usign personal information</h2>
    ...
    In addition to the disclosures reasonably necessary for the purposes identified elsewhere above, Shawod may disclose your personal information to the extent that it is required to do so by law, in connection with any legal proceedings or prospective legal proceedings, and in order to establish, exercise or defend its legal rights.</p>
                        <h2>Securing your data</h2>
                        <p>Shawod will take reasonable technical and organisational precautions to prevent the loss, misuse or alteration of your personal information.
    ...
    Information relating to electronic transactions entered into via this website will be protected by encryption technology.</p>
                        ...
                        <p>Information that Shawod collects may be stored and processed in and transferred between any of the countries
    ...
    You agree to such cross-border transfers of personal information.
                        ...
                        <p>Shawod may update this privacy policy by posting a new version on this website.
    ...
    Shawod is not responsible for the privacy policies or practices of any third party.</p>
     ...
     <Head>
        ...
        <meta name="description" content="Learn about the personal information that Shawod collects, and the ways in which Shawod uses that personal information.">
        ...
        <meta property="og:title" content="Privacy policy | Shawod">

        <meta property="og:description" content="about the personal information that Shawod collects, and the ways in which Shawod uses that personal information.">

         <meta property="og:image" content="https://shawod.com/public/assets/thumbnails/shawodTro.jpg">

         <meta property="og:url" content="https://shawod.com/privacy">
        ...
        <meta property="og:image" content="https://shawod.com/public/assets/thumbnails/shawodTro.jpg">
         ...
         <meta property="twitter:url" content="https://shawod.com/privacy">

         <meta property="twitter:title" content="Privacy policy | Shawod">

         <meta property="twitter:description" content="about the personal information that Shawod collects, and the ways in which Shawod uses that personal information.">
