<template>
  <BreadCrumb  title="Portfolio" description="Our pillars of strength."/>
...
<section id="portfolio-information" class="padding-top">
  <div class="container">
       ...
       <Title>
        <h1> Join our 
          <span class="typewrite" style="color:rgb(51,204,255)" data-period="100000" data-type='[ "Happy", "Satisfied" ]'> </span> Clients.</h1>
       </Title>
  
        <Clients />
        <RelatedWorks />
        <OurDeal title="Become our happy client" description="Select your desired package now."/>

<div class="container">
   <div id="progressbar-container">
     <h2 class="page-header">Services rendered</h2>
         <div class="progress">
           <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 30%">
               40% Applications and Softwares'
             </div>
          </div>
             <div class="progress">
               <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 20%">
                 30% Domains
                </div>
              </div>
            <div class="progress">
...
<section id="clients">
  <div class="container">
     <div class="row">
        <div class="col-sm-12">
          <div class="clients text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
             <p><img src="assets/images/portfolio/shasha.png" class="img-responsive" alt=""></p> <br>
   ...
   <Head>
        ...
        <meta name="description" content="View our happy clients' projects, Choose a Package and join our happy family.">
        ...
        <meta property="og:description" content="View our happy clients' projects, Choose a Package and join our happy family.">

         <meta property="og:image" content="https://shawod.com/public/assets/thumbnails/shawodTro.jpg">

         <meta property="og:url" content="https://shawod.com/portfolio">
        ...
        <meta property="og:image" content="https://shawod.com/public/assets/thumbnails/shawodTro.jpg">
         ...
         <meta property="twitter:url" content="https://shawod.com/portfolio">

         <meta property="twitter:title" content="Portfolio | Shawod">

         <meta property="twitter:description" content="View our happy clients' projects, Choose a Package and join our happy family.">
...
import RelatedWorks from '@/components/portfolio/relatedWorks.vue';
