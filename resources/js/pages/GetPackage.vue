<template>
    <BreadCrumb title="Packages"  description="Configure your package." />
    <Title>
...
<div style=" width: 360px; margin: 0px auto" align="center">
 ...
 import { getpackage } from '@/composables/getpackage'
 import Package from '@/components/packages/getPackage/Package.vue';
