...
<body style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color:#333;">
    <table class="container" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="header">
                <h1> <b>INITIAL DEPOSIT!</b> </h1>
                <span align="center" style="color: rgb(73,197,239);">LET GET STARTED</span>
  ...
  <use xlink:href="#gentle-wave" x="48" y="7" fill="#33ccff" />
        ...
        <tr>
            <td class="content">
                ...
                <p>Thank you for moving forward with <b>Shawod</b>.To begin sourcing the 
                   dedicated time required for your website development, I require a <b>50% upfront deposit.</b>
                   This allows us to maintain momentum and ensure there are no delays in the early stages of development.  I am looking forward to getting started!<br><br>
