...
<body style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color:#333;">
    <table class="container" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="header">
                <h1> <b>THANK YOU!</b> </h1>
                <span align="center" style="color: rgb(73,197,239);">PROJECT COMPLETE AND DEPLOYED</span>
  ...
  <use xlink:href="#gentle-wave" x="48" y="7" fill="#33ccff" />
            ...
            <td class="content">
                ...
                <p>Now that your website is officially live, I wanted to take a moment to <b>Thank you</b>
                  ...
                  <p>
                    I`ll be here if you need any further assistance or have questions as you settle into new system.
